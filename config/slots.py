...
CHECKITEM_HINTS = {
    ...
    "pastOps": "과거 수술/시술 이력. 예: '가슴 확대 1회', '필러 3회', '보톡스 2회', '없음'",
    "pastOpsSite": "과거 수술 부위. 예: '가슴', '얼굴', '이마', '가슴 좌측'",
    ...
    "concernArea": "관심/고민 부위. 예: '가슴', '가슴 볼륨', '팔자주름', '볼 꺼짐', '피부 탄력'",
    ...
    "lipoArea": "지방흡입 희망 부위. 예: '복부', '허벅지', '옆구리'",
    "lipoGoal": "지방흡입 목표/기대 결과. 예: '볼륨업', '바디라인 정리', '지방이식용 채취'",
    "lipoPlanDetail": "흡입 세부 계획. 예: '복부+허벅지 동시 흡입', '옆구리 집중 흡입'",
    ...
    "graftExpectation": "이식 기대 효과. 예: '자연스러운 볼륨', '탄력 개선', '볼 볼륨 회복'",

    # === P3 피부시술 ===
    "skinType": "피부 타입. 예: '건성', '지성', '복합성', '민감성'",
    "skinCondition": "현재 피부 상태. 예: '팔자주름 깊어짐', '볼 꺼짐', '피부 탄력 저하', '색소침착'",
    ...
    "procedurePlan": "시술 계획/선호 시술. 예: '필러+리프팅 결합', '보톡스+피부 탄력 관리'",
    "sunExposure": "자외선 노출 정도. 예: '야외 활동 많음', '실내 위주', '자외선 차단 꾸준히'",
    "skincareRoutine": "스킨케어 루틴. 예: '기초만', '풀코스', '거의 안 함'",
    "desiredEffect": "희망 효과. 예: '동안 느낌', '팔자주름 개선', '피부 탄력 회복', '흉터 최소화'",

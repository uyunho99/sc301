...
CONSULTATION_KEYWORDS: 식별 단어
CONSULTATION_SUBJECT_PATTERNS: 질문 주어 패턴
CONSULTATION_SCORE_WEIGHTS: 신호별 가중치
CONSULTATION_SCORE_THRESHOLD: 판별 임계값
CONSULTATION_RECOMMENDED_Q_MAP: 추천질문 → 상담 페르소나 매핑
CONSULTATION_TONE_STRATEGIES: 상담 톤/전략/금기
"""
